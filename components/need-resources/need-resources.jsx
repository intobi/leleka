...
const NeedResources = ({text, url}) => {
    ...
    const options = [
        ...
        {title: 'Загран паспорт', value: 'world-passport'},
        {title: 'ID - Карта', value: 'id-card'}
    ]
    ...
    return <div style={{minHeight: '100vh'}} className='wrapper'>
        <div className='header'>
            <div className='header__container'>
                ...
                <div>
                    <h1 style={{fontWeight: '700', fontSize: '40px'}}>Я потребую ресурси</h1>
                </div>
        ...
        <div style={{background: 'none'}} className='wrapper__content'>
            <div style={{marginTop: '56px'}}>
                <p className='need-resources-title'>Персональні дані</p>
                <div className='need-resources-form'>
                    <Input error={errors.last_name} title='Прізвище' name='last_name' value={state.last_name}
                           onChange={ChangeField}/>
                    <Input error={errors.first_name} title={`Ім'я`} name='first_name' value={state.first_name}
                           onChange={ChangeField}/>
                    <Input error={errors.third_name} title='По батькові' name='third_name' value={state.third_name}
                           onChange={ChangeField}/>
                    <Select
                        error={errors.type}
                        name='Тип документу'
                        ...
                        options={options}
                        call='Оберіть тип'/>
                    <Input error={errors.id_document} title='Серія та номер' name='id_document'
                           value={state.id_document} onChange={ChangeField}/>
                </div>
                <div className='need-resources-form-second'>
                    <PhoneField value={state.number} onChange={ChangeField} country={url}/>
                </div>
            </div>
        </div>
    </div>
